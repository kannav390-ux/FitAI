  ...
  return (
    <div
      className={`p-6 rounded flex gap-4 ${
        active ? "bg-[#1f2b49] border-l-4 border-blue-400" : "bg-[#111827]"
      }`}
    >
      <img
      ...
      <div className="flex flex-col gap-2">
        <button
          type="button"
          onClick={onSwap}
          className="flex items-center gap-2 px-4 py-2 bg-[#1f2b49] text-[#8eabff] text-[10px] font-black tracking-widest uppercase rounded-sm hover:bg-[#8eabff] hover:text-black transition-all"
        >
