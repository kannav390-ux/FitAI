    ...
    return (
      <div className="card h-full">
        ...
        <div className="mt-8 bg-[#192540] p-4 rounded-lg flex items-center gap-3">
          ...
          <span className="material-symbols-outlined text-[#8eabff]">
            trophy
          </span>
        ...
        {/* BUTTON */}
        <button className="w-full mt-6 py-3 border border-gray-600 text-xs uppercase tracking-wider rounded hover:bg-[#192540] transition">
          VIEW FULL ANALYTICS
        </button>
