        ...
        <div className="relative h-[500px] rounded-xl overflow-hidden group">
          ...
          <div className="absolute bottom-10 left-10 max-w-xl">
            ...
            <div className="flex gap-2 mb-4">
              <span className="bg-blue-600 px-2 py-1 text-xs font-bold">
                FEATURED
              </span>
            ...
            <h2 className="text-5xl font-black italic tracking-tight mb-4">
              KINETIC FLOW
            </h2>
            ...
            <div className="flex gap-4">
              <button className="px-8 py-3 bg-white text-black font-bold rounded flex items-center gap-2">
                ▶ START SESSION
              </button>
  
              <button className="px-6 py-3 border border-gray-600 rounded">
                DETAILS
              </button>
            </div>
